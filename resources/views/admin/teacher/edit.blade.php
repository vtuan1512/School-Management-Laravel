                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        @if(!empty($getRecord->getProfile_Teacher()))
                                        <img src="{{ $getRecord->getProfile_Teacher() }}" style="width: 150px; height: 150px;">
                                        @endif
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Current Address<span style="color: red;">*</span></label>
                                        <textarea type="text" class="form-control" name="address" rows="2">{{old('address',$getRecord->address)}}</textarea>
                                        <div style="color: red;">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea type="text" class="form-control" name="permanent_address"  rows="2">{{old('permanent_address',$getRecord->permanent_address)}}</textarea>
                                        <div style="color: red;">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea type="text" class="form-control" name="qualification" rows="2">{{old('qualification',$getRecord->qualification)}}</textarea>
                                        <div style="color: red;">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea type="text" class="form-control" name="work_experience" rows="2">{{old('work_experience',$getRecord->work_experience)}}</textarea>
                                        <div style="color: red;">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control" name="note" rows="2">{{ old('note', $getRecord->note) }}</textarea>
                                        <div style="color: red;">
                                            {{ $errors->first('note') }}
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <p style="color: red;">Do you want to change password so Please add new password</p>
                                </div>
                            </div>
                            <!-- /.card-body -->
